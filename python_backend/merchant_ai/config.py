...
class Settings(BaseSettings):
    ...
    llm_planner_timeout_seconds: int = Field(25, validation_alias="YSHOPPING_LLM_PLANNER_TIMEOUT_SECONDS")
    llm_answer_timeout_seconds: int = Field(15, validation_alias="YSHOPPING_LLM_ANSWER_TIMEOUT_SECONDS")
