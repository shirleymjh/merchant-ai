...
- 优惠券金额：SUM(coupon_amt)，单位=元，来源字段=coupon_amt，同义词=优惠券金额、优惠券面额、券面额、券金额、券金额投入、优惠券金额投入、优惠券投入、优惠投入、券投入、coupon_amt、coupon_total_amt
- 津贴金额：SUM(CAST(allowance_amt AS DECIMAL(18,2)))，单位=元，来源字段=allowance_amt，同义词=津贴金额、allowance_amt、allowance_total_amt
