...
('SO20260602001', '2026-06-02', 'O20260602001', 'buyer_001', '100', '待发货', '轻奢牛皮托特包 黑色', 1, 399.00, '支付成功', '2026-06-02 09:18:00'),
('SO20260601001', '2026-06-01', 'O20260601001', 'buyer_002', '100', '已发货', '复古运动鞋 白蓝', 2, 698.00, '支付成功', '2026-06-01 14:35:00'),
('SO20260530001', '2026-05-30', 'O20260530001', 'buyer_003', '100', '交易成功', '夏季防晒衬衫 米色', 1, 159.00, '支付成功', '2026-05-30 11:22:00');

INSERT INTO dwm_trade_refund_detail_di VALUES
('R20260601001', '2026-06-01', 'O20260601003', 'SO20260601003', '100', '待商家处理', '尺码不合适', '复古运动鞋 白蓝', 349.00, '2026-06-01 16:20:00'),
('R20260529001', '2026-05-29', 'O20260529002', 'SO20260529002', '100', '退款成功', '商品瑕疵', '轻奢牛皮托特包 黑色', 399.00, '2026-05-29 10:05:00');
