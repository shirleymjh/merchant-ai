...
- `python_backend/resources/wiki`: 平台规则和可复用 LLM wiki 记忆，人工可直接补充 Markdown。
...
- `POST /api/es/rebuild-recall-index?merchantId=100`：重建 recall 索引并灌入规则、基础记忆、runtime wiki 和已采纳历史问答
